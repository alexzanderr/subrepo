-- custom buffers like LeaderF
local buffers_with_only_filename = {}
...
function buffers_with_only_filename.gen_from_buffer_like_leaderf(opts)
  opts = opts or {}
...
return buffers_with_only_filename
